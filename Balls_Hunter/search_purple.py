...
# =======================
# Détection de balle violette
# =======================
BALL_DIAMETER_MM = 65
FOCAL_LENGTH = 673.97   # focale issue de ta calibration

# Plage HSV pour la BALLE VIOLETTE (à ajuster si besoin)
# H ∈ [0,179], S,V ∈ [0,255] en HSV OpenCV.[web:10][web:18]
# Plage HSV pour la BALLE VIOLETTE (plus large)
...
def detect_purple_ball(hsv_image):
...
print("=" * 50)
print("Recherche d’une balle VIOLETTE, centrage puis arrêt.\n")
...
try:
    ...
    while True:
        ...
        purple_ball = detect_purple_ball(hsv)
