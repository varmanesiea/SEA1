...
# =======================
# Avance asservie (approche + poussée)
# =======================
Kp = 0.2
PERIOD = 0.05
SPEED_FORWARD = 140
...
# =======================
BALL_DIAMETER_MM = 65
FOCAL_LENGTH = 673.97   # calibration distance/diamètre [web:44]
...
# Durée du dernier bond pour ~15 cm (à ajuster selon ton robot)
PUSH_DURATION_S = 0.40
...
print("=" * 50)
print("MISSION CHASSEUR DE BALLES – ÉTAPE 3")
print("=" * 50)
print("Recherche balle VERTE, centrage, approche 15 cm puis poussée.\n")
...
try:
    ...
    while True:
        ...
        os.system('clear')
        print("=" * 50)
        print("CHASSEUR DE BALLES – APPROCHE + POUSSÉE")
        print("=" * 50)
        ...
        if green_ball is None:
            ...
            # 2) balle centrée : gestion de la distance
                ...
                if dist > DISTANCE_CIBLE_CM + TOLERANCE_DISTANCE_CM:
                    ...
                    # On est dans la fenêtre autour de 15 cm : dernier bond
                    print(f"  Distance autour de la cible ({dist} cm)")
                    print("→ Action : POUSSÉE FINALE vers la balle")
                    avancer_asservi(duree_s=PUSH_DURATION_S)
                    stop()
                    print("\n→ Balle touchée, mission terminée ✅")
                    break
