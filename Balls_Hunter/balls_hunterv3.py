...
# =======================
# Détection balles : vert + violette + rouge
# =======================
BALL_DIAMETER_MM = 65
...
print("=" * 50)
print("MISSION CHASSEUR DE BALLES – VERT, VIOLETTE, ROUGE")
print("=" * 50)
print("1) Balle VERTE : approche 15 cm, poussée, recul")
print("2) Balle VIOLETTE : approche 15 cm, poussée, recul")
print("3) Balle ROUGE : approche 15 cm, poussée, arrêt.\n")
            ...
            if abs(dx) > TOLERANCE_X_PIXELS:
                ...
                if dist > DISTANCE_CIBLE_CM + TOLERANCE_DISTANCE_CM:
                    ...
                    if phase == "VERT":
                        ...
                        stop()
                        print("\n✓ Balle rouge poussée, mission complète ✅")
                        print("→ Balle verte, violette et rouge touchées, robot à l’arrêt.")
                        break
