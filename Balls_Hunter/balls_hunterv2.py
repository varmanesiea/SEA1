...
# =======================
# Détection balles : vert + violette
# =======================
BALL_DIAMETER_MM = 65
...
# violette (remplace l’ancienne BLEUE)
LOWER_PURPLE = np.array([110, 40, 90])
UPPER_PURPLE = np.array([165, 255, 255])
# Plage large couvrant bleu-violet → magenta, avec S/V suffisants pour ta balle violette.[web:51][web:18]
...
PUSH_DURATION_S = 0.60   # pousse ~15 cm
...
print("=" * 50)
print("MISSION CHASSEUR DE BALLES – VERT PUIS VIOLETTE")
print("=" * 50)
print("1) Cherche balle VERTE, approche 15 cm, poussée, recul")
print("2) Puis cherche balle VIOLETTE, approche 15 cm, poussée, arrêt.\n")
        ...
        if ball is None:
            ...
            if abs(dx) > TOLERANCE_X_PIXELS:
                ...
                if dist > DISTANCE_CIBLE_CM + TOLERANCE_DISTANCE_CM:
                    ...
                    if phase == "VERT":
                        # Après la verte : recul puis passer à la violette
                        ...
                        # Après la violette : fin de mission
                        stop()
                        print("\n✓ Balle violette poussée, mission complète ✅")
                        print("→ Balle verte puis balle violette touchées, robot à l’arrêt.")
                        break
